...
OPS = {
  ...
  'dil_conv_3x3' : lambda C, stride, affine: NormalConv(C, C, 3, stride, 2, 2, affine=affine),
  'dil_conv_5x5' : lambda C, stride, affine: NormalConv(C, C, 5, stride, 4, 2, affine=affine),
  ...
  'conv_3x3': lambda C, stride, affine: NormalConv(C, C, 3, stride, 1, 1, affine=affine),
